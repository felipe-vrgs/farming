...
# Resources
var pool_scene: PackedScene = preload("res://game/entities/particles/vfx.tscn")
var puff_config = preload("res://game/entities/particles/resources/walk_puff.tres")
var tile_break_config = preload("res://game/entities/particles/resources/tile_break.tres")
var water_splash_config = preload("res://game/entities/particles/resources/water_splash.tres")
